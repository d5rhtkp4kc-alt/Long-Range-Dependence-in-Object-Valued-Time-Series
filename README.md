...
* **R Packages:** ggplot2 (version 3.5.2), plot3D (version 1.4.1), transport (version 0.15-4), tidyr (version 1.3.1), parallel (version 4.5.0), foreach (version 1.5.2), doSNOW (version 1.0.20).
* **Python Packages:** Standard library modules for Python 3.13.13 --- os, glob. Third-party packages --- numpy (version 2.4.4), pandas (version 3.0.2), scipy (version 1.17.1).
...
3. data_download.ipynb --- Python functions to download and prepare the log return distribution data, with raw data from <https://www.kaggle.com/datasets/arashnic/stock-data-intraday-minute-bar/data>.
...
2. energy_final_residual.RData --- Preprocessed US energy generation composition data to remove trend and seasonlity. For details, see Section 5.2 of the paper.
